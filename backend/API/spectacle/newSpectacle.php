...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($data['title']) && isset($data['synopsis']) && isset($data['duration']) && isset($data['price']) && isset($data['language']) && isset($data['category_id'])) {
        ...
        $spectacle->setCategory_id($data['category_id']);
        ...
        echo json_encode([
            "status" => "error",
            "message" => "Title, synopsis, duration, price, language and category_id are required."
        ]);
    }
}